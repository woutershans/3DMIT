...
for idx = 1:length(oz)  
    ...
    %figName = "figs\Dowell_grid-rw.pdf"; exportgraphics(fig, figName, 'BackgroundColor', 'none', 'ContentType', 'vector');
    %figName = "figs\Dowell_grid-rw.png"; exportgraphics(fig, figName, 'BackgroundColor', 'white', 'Resolution', 600);
